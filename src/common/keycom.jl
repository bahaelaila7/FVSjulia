# KEYCOM.F77 — Keyword table (valid keyword names)
# Fortran COMMON /KEYCOM/ → module-level globals
# TABLE populated from bin/FVSsn_buildDir/keywds.f (BLOCK DATA KEYWDS)

const ISIZE_KEY = Int32(150)

# 8-char padded keyword names; empty slots are "        "
const TABLE = String[
    # 1-20
    "PROCESS ","TIMEINT ","FIXCW   ","TREEDATA","TREEFMT ","MPB     ",
    "DFTM    ","WSBW    ","CWEQN   ","DESIGN  ","NUMCYCLE","TFIXAREA",
    "GROWTH  ","STDINFO ","STDIDENT","INVYEAR ","TREELIST","REWIND  ",
    "NOSUM   ","DEBUG   ",
    # 21-40
